...
def login():
    if usernameEntry.get()=='' or passwordEntry.get()=='':
    ...
    elif usernameEntry.get()=='Sudakshina' and passwordEntry.get()=='1234':
        ...
        messagebox.showerror('Error','Please enter correct credenials')
...
loginButton=Button(loginFrame,text='Login',font=('times new roman',14,'bold'),width=15,fg='white',bg='cornflowerblue',activebackground='cornflowerblue',
